...
return [
    ...
    */
    ...
    'previous_password' => '変更前のパスワードと同じパスワードが入力されました。',
    ...
    'max' => [
        ...
        'file' => ':attributeには、5MB以下のファイルを指定してください。',
    ...
    'hankaku' => ':attributeは半角英数記号を指定してください。',
    /*
    |--------------------------------------------------------------------------
    | Custom バリデーション言語行
    |--------------------------------------------------------------------------
    ...
    */
    ...
    'attributes' => [
        ...
        'password' => 'パスワード',
        'select_license' => 'ライセンス',
        'input_name' => '資料名',
        'input_description' => '内容',
        'input_file_thumbnail' => 'サムネイル',
        'input_writer' => '作者名',
    ],
];
